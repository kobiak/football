...
self.addEventListener("message", function (event) {
    ...
    if (data.command == "trimCache") {
        trimCache(version + "pages", 3);
        trimCache(version + "images", 250);
...
self.addEventListener("fetch", function (event) {
   ...
   /* if (event.request.url.match(/wp-admin/) || event.request.url.match(/preview=true/) || event.request.url.match(/cdninstagram.com/)) {
        return;
    }*/
